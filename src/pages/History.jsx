...
const History = () => {
  ...
  // function for inserting the history
  ...
  // function for deleting the history
  ...
  return (
    <div className='container' style={{ paddingTop: '100px' }}>
      ...
      <table className="table m-5 shadow">
        <thead>
          <tr>
            <th>#</th>
            <th>Caption</th>
        ...
        <tbody>
          {
            allVideoHistory?.length > 0 ?
              ...
              :
              <div className='text-danger'>No videos are watched yet!!!</div>
          }
        </tbody>
      </table>
    </div>
